package cz.kr_vysocina.nis.v12.api;
...
@Api(tags = {"NIS-API-v12"})
@Path("api/nixzd/v12")
@Produces({MediaType.APPLICATION_XML})
@Consumes({MediaType.APPLICATION_XML})
public class NisApiV12 {

    private final Logger logger = LoggerFactory.getLogger(NisApiV12.class);
    private final IDataProvider m_dataProvider;

    public NisApiV12(IDataProvider dataProvider) {
